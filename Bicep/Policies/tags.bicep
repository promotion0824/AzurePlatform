...
resource rulesPolicySetName 'Microsoft.Authorization/policySetDefinitions@2023-04-01' = {
  ...
  properties: {
    ...
    policyDefinitions: [for (tag, i) in tags: {
      policyDefinitionId: extensionResourceId(mgScope, 'Microsoft.Authorization/policyDefinitions', tagPolicies[i].outputs.policyName)
...
resource remediationPolicySetName 'Microsoft.Authorization/policySetDefinitions@2023-04-01' = {
  ...
  properties: {
    ...
    description: remediateDisplayName
    policyType: 'Custom'
    metadata: {
      category: 'Tags'
    }
    ...
    policyDefinitions: [for (tag, i) in tags: {
      policyDefinitionId: extensionResourceId(mgScope, 'Microsoft.Authorization/policyDefinitions', 'ea3f2387-9b95-492a-a190-fcdc54f7b070')
