...
$AlertManifest = Get-ChildItem -Path $PSScriptRoot\AlertManifests -Filter "EventHub Queueing.yaml"
foreach ($AlertManifest in $AlertManifest) {
    ...
    foreach ($Resource in $Resources) {
        ...
        $template = Get-Content "$PSScriptRoot\AlertTemplates\EventHub Queueing Template.json" | ConvertFrom-Json
