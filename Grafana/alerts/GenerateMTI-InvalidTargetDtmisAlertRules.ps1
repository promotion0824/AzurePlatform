...
$AlertManifest = Get-ChildItem -Path $PSScriptRoot\AlertManifests -Filter "MTI-InvalidTargetDtmis.yaml"
foreach ($AlertManifest in $AlertManifest) {
    ...
    foreach ($Resource in $Resources) {
        ...
        $template = Get-Content "$PSScriptRoot\AlertTemplates\MTI-InvalidTargetDtmis.json" | ConvertFrom-Json
