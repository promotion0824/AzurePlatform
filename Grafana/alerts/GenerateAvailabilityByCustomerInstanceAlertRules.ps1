...
$AlertManifest = Get-ChildItem -Path $PSScriptRoot\AlertManifests -Filter "Availability by Customer Instance.yaml"
foreach ($AlertManifest in $AlertManifest) {
    ...
    foreach ($Resource in $Resources) {
        ...
        $template = Get-Content "$PSScriptRoot\AlertTemplates\Availability by Customer Instance Template.json" | ConvertFrom-Json
