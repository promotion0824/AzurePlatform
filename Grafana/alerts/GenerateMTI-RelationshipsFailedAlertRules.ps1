...
$AlertManifest = Get-ChildItem -Path $PSScriptRoot\AlertManifests -Filter "MTI-RelationshipsFailed.yaml"
foreach ($AlertManifest in $AlertManifest) {
    ...
    foreach ($Resource in $Resources) {
        ...
        $template = Get-Content "$PSScriptRoot\AlertTemplates\MTI-RelationshipsFailed.json" | ConvertFrom-Json
