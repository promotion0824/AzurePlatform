...
$AlertManifest = Get-ChildItem -Path $PSScriptRoot\AlertManifests -Filter "MTI-TwinsFailed.yaml"
foreach ($AlertManifest in $AlertManifest) {
    ...
    foreach ($Resource in $Resources) {
        ...
        $template = Get-Content "$PSScriptRoot\AlertTemplates\MTI-TwinsFailed.json" | ConvertFrom-Json
