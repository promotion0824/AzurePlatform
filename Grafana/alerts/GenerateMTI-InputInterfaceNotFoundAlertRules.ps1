...
$AlertManifest = Get-ChildItem -Path $PSScriptRoot\AlertManifests -Filter "MTI-InputInterfaceNotFound.yaml"
foreach ($AlertManifest in $AlertManifest) {
    ...
    foreach ($Resource in $Resources) {
        ...
        $template = Get-Content "$PSScriptRoot\AlertTemplates\MTI-InputInterfaceNotFound.json" | ConvertFrom-Json
